...
const getTimelineIcon = (
  item: TimelineItemData,
): { Icon: LucideIcon; gradient: string; bgGradient: string } => {
  ...
  if (
    titleLower.includes("secundaria") ||
  ...
  if (
    ...
    titleLower.includes("certificación")
  ) {
    return {
      Icon: Award,
...
const TimelineIcon = ({
  ...
  const { Icon, gradient } = getTimelineIcon(item);
